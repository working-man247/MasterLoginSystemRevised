...
(default, 'Guest', 0, 1, '', 0, 0, 0),
(default, 'Member', 1, 1, '#08c', 0, 0, 0),
(default, 'Moderator', 2, 1, 'green', 1, 1, 0),
(default, 'Administrator', 3, 1, '#F0A02D', 1, 1, 1);";
  ...
  $sqls[] = "
  INSERT INTO `".$prefix."privacy` (`userid`, `email`) VALUES (1, default);";
  $sqls[] = "
