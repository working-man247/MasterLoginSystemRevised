...
<div class=\"hero-unit\">
    ...
    <p>
        This is a template for a simple website. It includes a user system with signup, login, password recovery and many more. It's a perfect startup for your projects.
    </p>";
if(!$user->islg()) {
    echo "<p>
